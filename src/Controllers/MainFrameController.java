...
public class MainFrameController {
    ...
    public void FileLoadXML(ActionEvent actionEvent) {
        ...
        if (file.getName().contains("R071")){
            ...
            DirectSuccessorConstraint d1 = new DirectSuccessorConstraint(cavMap.get("C5PM26-A(A):2"), cavMap.get("C5PW10A(A):3"), cableTree.findWire(cavMap.get("C5PM26-A(A):2"), cavMap.get("C5PW10A(A):3")), cableTree.getCableStore().getPos());
            DirectSuccessorConstraint d2 = new DirectSuccessorConstraint(cavMap.get("C5PM26-A(A):1"), cavMap.get("C5PW10A(A):5"), cableTree.findWire(cavMap.get("C5PM26-A(A):1"), cavMap.get("C5PW10A(A):5")), cableTree.getCableStore().getPos());
